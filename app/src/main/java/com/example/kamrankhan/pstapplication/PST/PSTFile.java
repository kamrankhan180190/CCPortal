...
public class PSTFile {
	...
	private LinkedHashMap<Integer, LinkedList<com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode>> childrenDescriptorTree = null;
	...
	public PSTFile(String fileName)
		throws FileNotFoundException, com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		...
		throws FileNotFoundException, com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		...
		try {
			...
			if (!strValue.equals("!BDN")) {
				throw new com.example.kamrankhan.pstapplication.PST.PSTException("Invalid file header: "+strValue+", expected: !BDN");
			}
			...
			{
				throw new com.example.kamrankhan.pstapplication.PST.PSTException("Unrecognised PST File version: "+fileTypeBytes[0]);
			}
			...
			if (encryptionType == 0x02) {
				throw new com.example.kamrankhan.pstapplication.PST.PSTException("Only unencrypted and compressable PST files are supported at this time");
			}
			...
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("Unable to read PST Sig", err);
		}
...
/**/
		...
		com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode nameToIdMapDescriptorNode = (getDescriptorIndexNode(97));
		//nameToIdMapDescriptorNode.readData(this);

		// get the descriptors if we have them
		HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> localDescriptorItems = null;
		...
		com.example.kamrankhan.pstapplication.PST.OffsetIndexItem off = this.getOffsetIndexNode(nameToIdMapDescriptorNode.dataOffsetIndexIdentifier);
...
/**/
	...
	private byte [] getData(PSTTableItem item, HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> localDescriptorItems)
		throws IOException, com.example.kamrankhan.pstapplication.PST.PSTException
	{
		...
		if ( localDescriptorItems == null ) {
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("External reference but no localDescriptorItems in PSTFile.getData()");
		}
		
		if ( item.entryValueType != 0x0102 ) {
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("Attempting to get non-binary data in PSTFile.getData()");
		}

		com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem mapDescriptorItem = localDescriptorItems.get(item.entryValueReference);
		if (mapDescriptorItem == null) {
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("not here "+item.entryValueReference + "\n"+localDescriptorItems.keySet());
		}
	...
	{
		com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode messageStoreDescriptor = getDescriptorIndexNode(MESSAGE_STORE_DESCRIPTOR_IDENTIFIER);
	...
	public PSTFolder getRootFolder()
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode rootFolderDescriptor = getDescriptorIndexNode(ROOT_FOLDER_DESCRIPTOR_IDENTIFIER);
		...
		throws IOException, com.example.kamrankhan.pstapplication.PST.PSTException
	{
		...
		com.example.kamrankhan.pstapplication.PST.OffsetIndexItem offsetItem = getOffsetIndexNode(bid);
		...
		throws IOException, com.example.kamrankhan.pstapplication.PST.PSTException
	{
				 ...
				 (temp[0] == 0xffffff81 && temp[1] == 0xffffff81 && descTree))
		{
			...
			else
			{
				...
				throw new com.example.kamrankhan.pstapplication.PST.PSTException("Unable to find "+index);
			}
		}

		throw new com.example.kamrankhan.pstapplication.PST.PSTException("Unable to find node: "+index);
	}
	 ...
	 * @throws com.example.kamrankhan.pstapplication.PST.PSTException
	 */
	com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode getDescriptorIndexNode(long identifier)
		throws IOException, com.example.kamrankhan.pstapplication.PST.PSTException
	{
		return new com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode(findBtreeItem(in, identifier, true), this.getPSTFileType());
	}
	 ...
	 * @throws com.example.kamrankhan.pstapplication.PST.PSTException
	 */
	com.example.kamrankhan.pstapplication.PST.OffsetIndexItem getOffsetIndexNode(long identifier)
		throws IOException, com.example.kamrankhan.pstapplication.PST.PSTException
	{
		return new com.example.kamrankhan.pstapplication.PST.OffsetIndexItem(findBtreeItem(in, identifier, false), this.getPSTFileType());
	}
	 ...
	 */
	HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> getPSTDescriptorItems(long localDescriptorsOffsetIndexIdentifier)
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		return this.getPSTDescriptorItems(this.readLeaf(localDescriptorsOffsetIndexIdentifier));
	}
	HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> getPSTDescriptorItems(PSTNodeInputStream in)
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		...
		int sig = in.read();
		if (sig != 0x2) {
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("Unable to process descriptor node, bad signature: "+sig);
		}

		HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> output = new HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem>();
		...
		for (int x = 0; x < numberOfItems; x++) {
			com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem item = new com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem(data, offset, this);
	 ...
	 * @throws com.example.kamrankhan.pstapplication.PST.PSTException
	 */
	LinkedHashMap<Integer, LinkedList<com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode>> getChildDescriptorTree()
			throws IOException, com.example.kamrankhan.pstapplication.PST.PSTException
	{
		if (this.childrenDescriptorTree == null) {
			...
			this.childrenDescriptorTree = new LinkedHashMap<Integer, LinkedList<com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode>>();
		...
		if ((temp[0] == 0xffffff81 && temp[1] == 0xffffff81)) {
			...
			if (levelsToLeaf > 0) {
				...
				for (int x = 0; x < numberOfItems; x++) {
					...
					com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode tempNode = new com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode(temp, this.getPSTFileType());
					...
					if (tempNode.parentDescriptorIndexIdentifier == tempNode.descriptorIdentifier) {
						...
						LinkedList<com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode> children = childrenDescriptorTree.get(tempNode.parentDescriptorIndexIdentifier);
						children.add(tempNode);
					} else {
						// create a new entry and add this one to that
						LinkedList<com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode> children = new LinkedList<DescriptorIndexNode>();
						children.add(tempNode);
