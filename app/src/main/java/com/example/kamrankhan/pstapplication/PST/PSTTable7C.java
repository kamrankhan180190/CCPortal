...
class PSTTable7C extends com.example.kamrankhan.pstapplication.PST.PSTTable {
	...
	protected PSTTable7C(com.example.kamrankhan.pstapplication.PST.PSTNodeInputStream in, HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> subNodeDescriptorItems)
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		this(in, subNodeDescriptorItems, -1);
	}
	protected PSTTable7C(PSTNodeInputStream in, HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> subNodeDescriptorItems, int entityToExtract)
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		...
		if (tableTypeByte != 0x7c)
		{
			...
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("unable to create PSTTable7C, table does not appear to be a 7c!");
		}
