...
public class PSTContact extends PSTMessage {
	 ...
	 * @throws IOException
	 */
	public PSTContact(PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode descriptorIndexNode)
	 ...
	 */
	public PSTContact(PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode folderIndexNode, PSTTableBC table, HashMap<Integer, PSTDescriptorItem> localDescriptorItems) {
