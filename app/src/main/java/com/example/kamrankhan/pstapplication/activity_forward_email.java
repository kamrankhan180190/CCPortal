...
public class activity_forward_email extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateTxt=emailObjects.getString("dateTxt", null);
        ...
        editTextSubject.setText("Fwd: "+subjectTxt);

        editTextMessage.setText("------Forwarded Message------"+"\n"+"From: "+senderNameTxt+"<"+senderEmailTxt+">"+"\n"+"Subject: "+subjectTxt+"\n"+"Date: "+dateTxt+"\n");
