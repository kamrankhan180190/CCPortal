...
public class PSTTimeZone {
	PSTTimeZone(byte [] timeZoneData) {
		...
		try {
			int headerLen = (int) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, 2, 4);
			int nameLen = 2*(int) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, 6, 8);
			name = new String(timeZoneData, 8, nameLen, "UTF-16LE");
			int ruleOffset = 8+nameLen;
			int nRules = (int) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, ruleOffset, ruleOffset+2);

			ruleOffset = 4 + headerLen;
			for ( int rule = 0; rule < nRules; ++rule ) {
				// Is this rule the effective rule?
				int flags = (int) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, ruleOffset+4, ruleOffset+6);
				if ( (flags & 0x0002) != 0 ) {
	...
	public class SYSTEMTIME {
		...
		SYSTEMTIME(byte[] timeZoneData, int offset) {
			wYear = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset, offset+2)&0x7FFF);
			wMonth = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+2, offset+4)&0x7FFF);
			wDayOfWeek = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+4, offset+6)&0x7FFF);
			wDay = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+6, offset+8)&0x7FFF);
			wHour = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+8, offset+10)&0x7FFF);
			wMinute = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+10, offset+12)&0x7FFF);
			wSecond = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+12, offset+14)&0x7FFF);
			wMilliseconds = (short)(com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+14, offset+16)&0x7FFF);
		}
	...
	private class TZRule {
		...
		TZRule(SYSTEMTIME dtStart, byte[] timeZoneData, int offset) {
			...
			short wStandardYear = (short) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+12, offset+14);
			startStandard = new SYSTEMTIME(timeZoneData, offset+14);
			@SuppressWarnings("unused")
			short wDaylightYear = (short) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+30, offset+32);
		...
		private void InitBiases(byte[] timeZoneData, int offset) {
			lBias = (int) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset, offset+4);
			lStandardBias = (int) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+4, offset+8);
			lDaylightBias = (int) com.example.kamrankhan.pstapplication.PST.PSTObject.convertLittleEndianBytesToLong(timeZoneData, offset+8, offset+12);
		}
