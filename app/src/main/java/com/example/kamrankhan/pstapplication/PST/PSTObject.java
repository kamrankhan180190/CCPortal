...
import com.example.kamrankhan.pstapplication.PST.PSTActivity;
import com.example.kamrankhan.pstapplication.PST.PSTAppointment;
import com.example.kamrankhan.pstapplication.PST.PSTContact;
...
public class PSTObject {
	...
	protected com.example.kamrankhan.pstapplication.PST.PSTFile pstFile;
	protected byte[] data;
	protected com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode descriptorIndexNode;
	protected HashMap<Integer, PSTTableBCItem> items;
	protected HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> localDescriptorItems = null;
	
	protected LinkedHashMap<String, HashMap<com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode, PSTObject>> children;
	
	protected PSTObject(com.example.kamrankhan.pstapplication.PST.PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode descriptorIndexNode)
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		...
		PSTTableBC table = new PSTTableBC(new com.example.kamrankhan.pstapplication.PST.PSTNodeInputStream(pstFile, pstFile.getOffsetIndexNode(descriptorIndexNode.dataOffsetIndexIdentifier)));
	 ...
	 * @param table
	 */
	protected PSTObject(com.example.kamrankhan.pstapplication.PST.PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode folderIndexNode, PSTTableBC table, HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> localDescriptorItems) {
		this.pstFile = theFile;
	 ...
	 */
	public com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode getDescriptorNode() {
	...
	protected String getStringItem(int identifier, int stringType, String codepage) {
		...
		if ( item != null ) {
			...
			{
				// we have a hit!
				com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem descItem = this.localDescriptorItems.get(item.entryValueReference);
				...
				try {
					...
					System.err.printf("Exception %s decoding string %s: %s\n",
							e.toString(),
							com.example.kamrankhan.pstapplication.PST.PSTFile.getPropertyDescription(identifier, stringType), data != null ? data.toString() : "null");
					return "";
				}
	...
	private String getStringCodepage() {
		...
		if (cpItem != null) {
			return com.example.kamrankhan.pstapplication.PST.PSTFile.getInternetCodePageCharset(cpItem.entryValueReference);
		}
		return null;
	}
...
/**/
	 ...
	 */
	public static PSTObject detectAndLoadPSTObject(com.example.kamrankhan.pstapplication.PST.PSTFile theFile, long descriptorIndex)
	 ...
	 * @throws com.example.kamrankhan.pstapplication.PST.PSTException
	 */
	static PSTObject detectAndLoadPSTObject(com.example.kamrankhan.pstapplication.PST.PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode folderIndexNode)
		throws IOException, com.example.kamrankhan.pstapplication.PST.PSTException
	{
		int nidType = (folderIndexNode.descriptorIdentifier & 0x1F);
		if ( nidType == 0x02 || nidType == 0x03 || nidType == 0x04 ) {

			PSTTableBC table = new PSTTableBC(new com.example.kamrankhan.pstapplication.PST.PSTNodeInputStream(theFile, theFile.getOffsetIndexNode(folderIndexNode.dataOffsetIndexIdentifier)));
			...
			if ( nidType == 0x02 || nidType == 0x03 ) {
				return new com.example.kamrankhan.pstapplication.PST.PSTFolder(theFile, folderIndexNode, table, localDescriptorItems);
			} else  {
		...
		{			
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("Unknown child type with offset id: "+folderIndexNode.localDescriptorsOffsetIndexIdentifier);
		}
	}

	static com.example.kamrankhan.pstapplication.PST.PSTMessage createAppropriatePSTMessageObject(com.example.kamrankhan.pstapplication.PST.PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode folderIndexNode, PSTTableBC table, HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> localDescriptorItems)
	{
		...
		if (messageClass.equals("IPM.Note")) {
			return new com.example.kamrankhan.pstapplication.PST.PSTMessage(theFile, folderIndexNode, table, localDescriptorItems);
