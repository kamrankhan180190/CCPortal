...
import com.example.kamrankhan.pstapplication.PST.LZFu;
import com.example.kamrankhan.pstapplication.PST.PSTAttachment;
...
public class PSTMessage extends PSTObject {
	...
	PSTMessage(com.example.kamrankhan.pstapplication.PST.PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode descriptorIndexNode)
			throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		super(theFile, descriptorIndexNode);
	}

	PSTMessage(com.example.kamrankhan.pstapplication.PST.PSTFile theFile, com.example.kamrankhan.pstapplication.PST.DescriptorIndexNode folderIndexNode, PSTTableBC table, HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> localDescriptorItems)
	{
		...
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		...
		if (this.items.containsKey(0x1009))
		{
			...
			if (item.data.length > 0) {
				return (com.example.kamrankhan.pstapplication.PST.LZFu.decode(item.data));
			}
			int ref = item.entryValueReference;
			com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem descItem = this.localDescriptorItems.get(ref);
			if ( descItem != null ) {
...
//	}
	...
	public String getBody() {
		...
		if (cpItem != null) {
			cp = com.example.kamrankhan.pstapplication.PST.PSTFile.getInternetCodePageCharset(cpItem.entryValueReference);
		}
	...
	private void processRecipients()
	{
		try {
			...
			{
				com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem item = this.localDescriptorItems.get(recipientTableKey);
				HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> descriptorItems = null;
		...
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		...
		{
			com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem item = this.localDescriptorItems.get(attachmentTableKey);
			HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> descriptorItems = null;
			if (item.subNodeOffsetIndexIdentifier > 0) {
				descriptorItems =pstFile.getPSTDescriptorItems(item.subNodeOffsetIndexIdentifier);
			}
	...
	public Date getTaskStartDate() {
		return getDateItem(pstFile.getNameToIdMapItem(0x00008104, com.example.kamrankhan.pstapplication.PST.PSTFile.PSETID_Task));
	}
	/**
	 * Due date Filetime
	 */
	public Date getTaskDueDate() {
		return getDateItem(pstFile.getNameToIdMapItem(0x00008105, com.example.kamrankhan.pstapplication.PST.PSTFile.PSETID_Task));
	}
	...
	public boolean getReminderSet() {
		return getBooleanItem(pstFile.getNameToIdMapItem(0x00008503, com.example.kamrankhan.pstapplication.PST.PSTFile.PSETID_Common));
	}
			...
			throws com.example.kamrankhan.pstapplication.PST.PSTException
	{
		...
		if (this.items.containsKey(keywordCategory)) {
			try {
				...
				throw new com.example.kamrankhan.pstapplication.PST.PSTException("Unable to decode category data", err);
			}
		}
		return categories;
	}
	 ...
	 * @throws IOException
	 */
	public com.example.kamrankhan.pstapplication.PST.PSTAttachment getAttachment(int attachmentNumber)
		throws com.example.kamrankhan.pstapplication.PST.PSTException, IOException
	{
		this.processAttachments();
		...
		if (attachmentNumber >= attachmentCount) {
			throw new com.example.kamrankhan.pstapplication.PST.PSTException("unable to fetch attachment number "+attachmentNumber+", only "+attachmentCount+" in this email");
		}
		...
		com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem descriptorItem = this.localDescriptorItems.get(descriptorItemId);
		...
		if ( attachmentData != null && attachmentData.length > 0 ) {
			...
			HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem> attachmentDescriptorItems = new HashMap<Integer, com.example.kamrankhan.pstapplication.PST.PSTDescriptorItem>();
		...
		throw new com.example.kamrankhan.pstapplication.PST.PSTException("unable to fetch attachment number "+attachmentNumber+", unable to read attachment details table");
	}
